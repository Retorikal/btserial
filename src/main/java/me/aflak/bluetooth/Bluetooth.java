...
public class Bluetooth {
    ...
    public Bluetooth(Service service){
    ...
    public void scanDevices(){
        ...
        service.registerReceiver(mReceiverScan, filter);
        bluetoothAdapter.startDiscovery();
    }

    public void pair(BluetoothDevice device){
        service.registerReceiver(mPairReceiver, new IntentFilter(BluetoothDevice.ACTION_BOND_STATE_CHANGED));
        devicePair=device;
        try {
